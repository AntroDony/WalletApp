...
sealed class AnalyticsUiEvent: UiEvent{
    data class GetAnalyticsByPeriod(val period: AnalyticsPeriod): AnalyticsUiEvent()
    data class GetTransactionsByType(val transactionType: TransactionType?): AnalyticsUiEvent()
